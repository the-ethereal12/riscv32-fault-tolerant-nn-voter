...
REM
REM Generated by Vivado on Sun Apr 05 18:48:34 +0530 2026
...
echo "xvlog --incr --relax -prj tmr_tb_vlog.prj"
call xvlog  --incr --relax -prj tmr_tb_vlog.prj -log xvlog.log
